...
var map = {
	...
	"../pages/hello-ionic/hello-ionic.module": [
		273,
		3
	],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_md5__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_md5___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_md5__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__(223);
...
var AuthService = (function () {
        ...
        if (credentials.email === null || credentials.password === null) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].create(function (observer) {
                _this.storage.get(credentials.email).then(function (password) {
                    if (password == __WEBPACK_IMPORTED_MODULE_3_md5__(credentials.password)) {
                        observer.next(true);
                    }
                    else {
                        observer.next(false);
    ...
    AuthService.prototype.register = function (credentials) {
        ...
        if (credentials.email === null || credentials.password === null) {
            ...
            return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].create(function (observer) {
                _this.storage.set(credentials.email, __WEBPACK_IMPORTED_MODULE_3_md5__(credentials.password));
                observer.next(true);
                observer.complete();
            });
        }
...
HelloIonicPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-hello-ionic',template:/*ion-inline-start:"/home/jcm/IONIC/MyIonicProject/src/pages/hello-ionic/hello-ionic.html"*/'<!--\n  Generated template for the HelloIonicPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>hello-ionic</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n\n</ion-content>\n'/*ion-inline-end:"/home/jcm/IONIC/MyIonicProject/src/pages/hello-ionic/hello-ionic.html"*/,
    }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_hello_ionic_hello_ionic__ = __webpack_require__(196);
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["d" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__app_component__["a" /* MyApp */], {}, {
                links: [
                    ...
                    { loadChildren: '../pages/hello-ionic/hello-ionic.module#HelloIonicPageModule', name: 'HelloIonicPage', segment: 'hello-ionic', priority: 'low', defaultHistory: [] },
